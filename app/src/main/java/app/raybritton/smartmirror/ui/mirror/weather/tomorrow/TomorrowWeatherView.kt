...
class TomorrowWeatherView : BaseFragment<TomorrowWeatherViewModel>(TomorrowWeatherViewModel::class.java) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        weather_label.setText(R.string.section_tomorrow)
        ...
        viewModel.weatherData.observe { weatherStatus ->
            when (weatherStatus) {
                ...
                is WeatherStatus.Success -> {
                    ...
                    setupUi(weatherStatus.weather.tomorrow)
                }
